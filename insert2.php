...
(panchayat_name, name,ifc_code,account_no,month_of_sal,fta,gred_pay,basic,da,ddo_code,s_id,tot_da,total_amount
  ,total_days,present,total_tax_d,Income_tax,other_ded,per_of_salary,sal_ded,net_sal,year,tvr_no,tvr_date,bill_no,bill_date,fin_year,
  final_total,status,bill_type,nps_ded) 
...
{
require('conn1.php');
$query2="DELETE FROM tbl_sachive_account ";
