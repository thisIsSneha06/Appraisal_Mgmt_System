				...
				<div class="row">
					<div class="col-md-6 border-right">
						...
						<div class="row " id="ratings-field" style="display: none">
							<div class="col-md-12">
							<label for="" class="control-label"><b class="border-bottom border-primary">PARAMETERS:</b></label><br>
							</div>
							<hr>
							<div class="col-md-6">
								<div class="form-group">
							...
							<div class="col-md-6">
							<div class="form-group">
									<label for="" class="control-label">Communication</label>
									<select name="communication" id="communication" class="form-control form-control-sm" required>
										<?php 
										for($i = 5; $i >= 0;$i--):
										?>
										<option <?php echo isset($communication) && $communication == $i ? "selected" : '' ?>><?php echo $i ?></option>
										<?php endfor; ?>
									</select>
								</div>
								<div class="form-group">
									<label for="" class="control-label">Creativity</label>
									<select name="creativity" id="creativity" class="form-control form-control-sm" required>
										<?php 
										for($i = 5; $i >= 0;$i--):
										?>
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="" class="control-label">Attention to details</label>
									<select name="attention" id="attention" class="form-control form-control-sm" required>
										<?php 
										for($i = 5; $i >= 0;$i--):
										?>
										<option <?php echo isset($attention) && $attention == $i ? "selected" : '' ?>><?php echo $i ?></option>
										<?php endfor; ?>
									</select>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<select name="presentation" id="presentation" class="form-control form-control-sm" required>
										<?php 
										for($i = 5; $i >= 0;$i--):
										?>
										<option <?php echo isset($presentation) && $presentation == $i ? "selected" : '' ?>><?php echo $i ?></option>
										<?php endfor; ?>
									</select>
								</div>
								<div class="form-group">
									<label for="" class="control-label">Overall Quality</label>
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="" class="control-label">Consistency</label>
									<select name="consistency" id="consistency" class="form-control form-control-sm" required>
										<?php 
										for($i = 5; $i >= 0;$i--):
										?>
										<option <?php echo isset($consistency) && $consistency == $i ? "selected" : '' ?>><?php echo $i ?></option>
										<?php endfor; ?>
									</select>
								</div>
								<div class="form-group">
									<label for="" class="control-label">Team Work</label>
									<select name="teamwork" id="teamwork" class="form-control form-control-sm" required>
										<?php 
										for($i = 5; $i >= 0;$i--):
										?>
										<option <?php echo isset($teamwork) && $teamwork == $i ? "selected" : '' ?>><?php echo $i ?></option>
										<?php endfor; ?>
									</select>
								</div>
								<div class="form-group">
									<label for="" class="control-label">Punctuality</label>
									<select name="punctuality" id="punctuality" class="form-control form-control-sm" required>
										<?php 
										for($i = 5; $i >= 0;$i--):
										?>
										<option <?php echo isset($punctuality) && $punctuality == $i ? "selected" : '' ?>><?php echo $i ?></option>
										<?php endfor; ?>
									</select>
								</div>
							</div>
					...
					<div class="col-md-6">
						<div id="post-field">
							<div><center><i>Select Employee First</i></center></div>
						</div>
					</div>
				</div>
				<hr>
