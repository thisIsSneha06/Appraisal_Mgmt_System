<!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-primary navbar-dark" style="background-color: #1464bf;">
    <ul class="navbar-nav">
    ...
    <?php endif; ?>
      <li>
        <a class="nav-link text-white"  href="./" role="button"> <large><b>Appraisal Management System</b></large></a>
      </li>
    </ul>
