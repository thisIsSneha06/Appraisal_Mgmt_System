<aside class="main-sidebar sidebar-dark-primary elevation-4">
  <div class="dropdown">
  <a href="./" class="brand-link" style="background-color: #07274b;color: #f2f0f0d1;">
  ...
  <div class="sidebar pb-4 mb-4" style="background-color: #07274b;color: #f2f0f0d1;">
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item dropdown">
          <a href="./index.php?page=appraisal" class="nav-link nav-appraisal">
